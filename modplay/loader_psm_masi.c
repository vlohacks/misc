...
module_t * loader_psm_masi_load(io_handle_t * h)
{
    ...
    /* chech if we really deal with a PSM file. IF not, bail out */
...
int loader_psm_masi_MAIN(io_handle_t * h) {
    // TODO?
    return 0;
}

int loader_psm_masi_SONG(io_handle_t * h) {
    // TODO?
    return 0;
}

int loader_psm_masi_FILE(io_handle_t * h) {
    // TODO?
    return 0;
}

int loader_psm_masi_SDFT(io_handle_t * h) {
    // TODO?
    h->seek(h, 4, io_seek_cur);
    return 0;
}

int loader_psm_masi_PBOD(io_handle_t * h) {
