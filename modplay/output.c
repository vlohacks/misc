...
//    { output_driver_alsa, output_alsa_init, output_alsa_cleanup, output_alsa_start, output_alsa_stop } // TODO alsa driver needs rework
};

#endif      // DOS

int output_selected_driver_index = -1;
